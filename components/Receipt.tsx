                ...
                <div className="p-6">
                    <div className="text-gray-800 dark:text-gray-200">
                        <div className="text-center mb-6">
                            <h2 className="text-xl font-bold">ระบบ POS ร้านปิ้งย่างเจ้นุ้ย</h2>
                     ...
                     <div className="flex justify-end gap-3 pt-6 mt-4 border-t border-gray-200 dark:border-gray-700 no-print">
